...
# Replace with your Google Apps Script web app URL
GOOGLE_SCRIPT_URL2 = "https://script.google.com/macros/s/AKfycbzS6aAizNGfyb2Qgy4SDsBI2-biRTMJxSQxFY_7H27ZFbwvgXgH87cf5YPRnq_DAzNw_w/exec"
...
def webbhook():
    ...
    # Send the data to Google Apps Script
    response = requests.post(GOOGLE_SCRIPT_URL2, json=data)
